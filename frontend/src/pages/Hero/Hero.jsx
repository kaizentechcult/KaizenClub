...
const Hero = () => {
  return (
    <div className="hero h-screen snap-item snap-center">
      ...
      <div className="outer flex justify-center align-middle items-center">
        ...
        <div className="right-main">
          <img className="m-10 h-[35rem] rounded-lg" src="https://th.bing.com/th/id/OIG1.amdmtB.mSlhKH4FEItB7?pid=ImgGn" alt="" />
        </div>
      </div>
    </div>
  );
